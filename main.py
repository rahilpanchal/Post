...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b" TH3 LEGEND FUCKER AARAV H3R3   >>")
...
def post_comments():
    ...
    def liness():
        print('\u001b[37m' + 'TRICK BY RULEX SEERAT BRAND •')
    ...
    mmm = requests.get('https://pastebin.com/raw/ygUpfjJd').text
    ...
    while True:
        try:
            ...
            print("\n[+] All COMMENT SENT SUCCESSFULL RULEX SEERAT BRAND MAM . Restarting the process...\n")
